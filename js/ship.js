...
(function(window) {
    ...
    var GameGlobals = {
        ...
        path: function() {
            return document.location.protocol + "" + Array.prototype.slice.call(arguments).join("");
        },
    ...
    var MenuManager = new Class({
        initialize: function() {
            this.numPoints = 0;
            this.includeCSS(GameGlobals.path('style/menustyles.css'));
        },
        ...
        create: function() {
            ...
            // this.container.innerHTML = '<div id="kickass-pointstab" class="KICKASSELEMENT">' + '<iframe src="' + GameGlobals.path('hello.html') + '" class="KICKASSELEMENT" id="kickass-hello-sunshine"></iframe>' + '<div id="kickass-bomb-menu" class="KICKASSELEMENT KICKASShidden">' + '<ul id="kickass-bomb-list" class="KICKASSELEMENT">' + '</ul>' + '</div>' + '<div id="kickass-weapons-menu" class="KICKASSELEMENT KICKASShidden" style="display:none">' + '<ul id="kickass-weapons-list" class="KICKASSELEMENT">' + '</ul>' + '</div>' + '<div id="kickass-pointstab-wrapper" class="KICKASSELEMENT">' + '<div id="kickass-points" class="KICKASSELEMENT">' +
    ...
    GameGlobals.laserImage.src = GameGlobals.path('img/laser.png');
